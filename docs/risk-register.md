...
| R-25 | La conexión se declara inestable entre tema y tema porque la consola calla los medidores durante el silencio | Media | Alta | Medido el 2026-09-08: con la consola en silencio, 1 trama VU2 en 30 s; con música, 1932 en 90 s. El vigilante de `ui24r-adapter.ts` pasa a UNSTABLE cuando el hueco entre tramas supera el umbral, así que hoy marcaría inestable cada silencio. La RTA llega a 30 Hz incondicionalmente y es la candidata a señal de vida, pero la supresión encaja con dos mediciones y no es un mecanismo observado: falta ver la transición de música a silencio | Abierto |

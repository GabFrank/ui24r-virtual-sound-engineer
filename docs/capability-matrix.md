...
| Cola de `VU2`: línea, subgrupos, efectos, auxiliares y general | — | — | **MEDIDO el 2026-09-09.** Trama de 306 bytes; la cola son 154 y las secciones **no comparten el paso**: línea de a 6, subgrupos y efectos de a 7, auxiliares de a 5. Reparto completo en `protocol-spec.md` §4.3. **Falta** el papel de cada byte dentro del bloque de subgrupo y de efecto | ✅ como reparto, ⬜ por byte | P0.10b, P0.2c |
...
| Difusión de una escritura a los demás clientes | — | — | **CONFIRMADO.** El cambio escrito por un cliente sí llega a los otros: la aplicación en la tablet lo registró como `cambio_externo` en el mismo instante. **Medido el 2026-09-09**: dos conexiones del mismo proceso son dos clientes distintos, y el testigo ve la escritura a los 27 ms. Es lo que ADR-024 usó para decidir | ✅ | P0.1, ACK-POLICY |

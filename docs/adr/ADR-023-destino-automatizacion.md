...
**Lo que no se mueve nunca:** INV-010. Ningún envío de monitor recibe escrituras. Un automatizador que puede alterar lo que oye un músico en el escenario no es un producto mejor, es un producto peligroso, y la única excepción sigue siendo la que ya está escrita. Si eso obliga a renunciar a apoyarse en el CUE nativo —lo dirá SPK-FW3— se renuncia al CUE, no a la invariante.

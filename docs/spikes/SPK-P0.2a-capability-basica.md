...
| 6 | `docs/capability-matrix.md` versión 1 y `docs/protocol-spec.md` versión 1 generados | bloqueante | ambos | **Los dos existen y dicen «Versión 1».** La matriz tiene **77 filas con estado, 29 verificadas** contra el aparato; la especificación tiene 554 líneas y encabeza con la consola de referencia y su firmware | ✅ |

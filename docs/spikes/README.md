...
- **La que sigue abierta no es de este spike.** Es *«¿la consola **mide** el
  medidor post-fader o lo **calcula**?»*, que nació en el ítem 99b y se sacó de su
  contrato antes de correr, porque 37 ms es menos que un cuadro de 44 y el control
  estaba garantizado a dar el resultado que se iba a leer. Medirla de verdad pide
  un instrumento que todavía no existe. Vive en
  [`../backlog/la-balistica-del-medidor-es-otra-medicion.md`](../backlog/la-balistica-del-medidor-es-otra-medicion.md),
  y **no bloquea a P0.10b**: lo único que lo bloquea son los criterios 1 y 2.

...
|---|---|---|---|---|---|
| 1 | Tabla parámetro a método de confirmación, completa | bloqueante | 100 % de las filas de la matriz | **Escrita, y medida en vez de redactada — pero el criterio pide más de lo que se midió, y eso hay que decirlo.** La matriz tiene **21 filas**; el barrido recorrió **18 rutas**, así que «100 % de las filas» es la meta, no el resultado. Las dos filas que nadie barrió quedan marcadas **Inferido**, diciendo que lo son. De las 18: **18 de 18 difundidas y vistas por el testigo**, las dos veces. **Restauradas y comprobadas desde fuera**: eran 11 de 18 el 2026-09-10 —la relectura del propio arnés decía 18, el volcado HTTP independiente cubría 11— y son **18 de 18 el 2026-09-11**. Que no se movió ninguna otra clave **se afirmó sin archivo y ahora lo archiva la propia medición**: `evidence/barrido-testigo-2026-09-11b.txt` lee las 6732 claves por HTTP antes y después y dice «ninguna», y trae además la enumeración del canal antes de escribir. **La latencia no reprodujo**: mediana 17 ms entonces, 0 ahora, y **por qué no está medido** — la explicación de «la red de esa noche» no se sostiene y se retiró. `evidence/barrido-testigo-2026-09-10.txt` —**transcripción sin archivar**—, `evidence/barrido-testigo-2026-09-11.txt` y `evidence/barrido-testigo-2026-09-11b.txt` | ✅ |

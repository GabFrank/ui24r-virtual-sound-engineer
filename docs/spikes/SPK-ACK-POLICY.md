...
|---|---|---|---|---|---|
| 1 | Tabla parámetro a método de confirmación, completa | bloqueante | 100 % de las filas de la matriz | **Escrita, y medida en vez de redactada — pero el criterio pide más de lo que se midió, y eso hay que decirlo.** La matriz tiene **21 filas**; el barrido recorrió **18 rutas**, así que «100 % de las filas» es la meta, no el resultado. Las dos filas que nadie barrió quedan marcadas **Inferido**, diciendo que lo son. De las 18: **18 de 18 difundidas y vistas por el testigo**, las dos veces. **Restauradas y comprobadas desde fuera**: eran 11 de 18 el 2026-09-10 —la relectura del propio arnés decía 18, el volcado HTTP independiente cubría 11— y son **18 de 18 el 2026-09-11**, con cero claves más movidas en toda la consola. **La latencia no reprodujo y no es del aparato**: mediana 17 ms entonces, **mediana 0 y máximo 1** ahora. `evidence/barrido-testigo-2026-09-10.txt` —**transcripción sin archivar**— y `evidence/barrido-testigo-2026-09-11.txt` | ✅ |

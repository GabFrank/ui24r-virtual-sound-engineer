# Plan, backlog y auditorías

| Documento | Qué es |
|---|---|
| [00-plan-final.md](00-plan-final.md) | Resumen ejecutivo |
...
## Cómo se leen los identificadores

| Prefijo | Qué es |
|---|---|
| `EP-nn` | Épica |
| `S-nn.m` | Historia |
| `SPK-*` | Spike, con criterio numérico |
| `G-x` | Control de paso |
| `DEC-*` | Decisión pendiente de un resultado |
| `INV-nnn` | Invariante de seguridad |
| `ADR-nnn` | Decisión de arquitectura |
| `R-nn` | Riesgo del registro |

...
| P0.9 | Avalancha detectada | bloqueante | 10 de 10 | **10 de 10 contra la consola el 2026-09-10**, con un segundo cliente escribiendo 16 rutas distintas de golpe y las 16 restauradas. Ya no depende del simulador, que disparaba la avalancha porque nosotros se lo pedíamos. Falta el disparador que el criterio nombra —una **recuperación de instantánea**, que además cambia `var.currentSnapshot`—: es la operación de mayor alcance del protocolo y hacerla sobre la consola del usuario se pregunta antes. Y salió un hallazgo: el aviso informa **10** cuando cambiaron 16, porque emite el tamaño en el instante de cruzar el umbral | 🟡 |

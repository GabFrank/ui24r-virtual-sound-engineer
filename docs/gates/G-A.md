...
> **Repaso del 2026-09-15.** Las tres madrugadas del 11 al 13 **no cambiaron ninguna marca de resultado** de esta tabla —sí se editaron celdas el 2026-09-11, entre ellas la de ACK-POLICY— porque lo que se midió esas noches es de G-B y G-C: leyes de conversión, el medidor contra un instrumento externo, el compresor. Lo que sí cambió es el contexto en que este control se lee: **el motor tiene tres categorías de escritura abiertas** (ADR-026, ADR-027, ADR-028), aunque de ellas sólo la ganancia llegue hoy a la consola desde una pantalla, y lo que este control desbloquea —el adaptador y la máquina de estados de conexión— está en uso con esa escritura encima. Los dos criterios que faltan siguen necesitando a alguien frente al aparato, y la auditoría externa del mismo día (`docs/backlog/auditorias/2026-09-15-auditoria-externa.md`, §5) trae hipótesis con procedencia para el modo «router apagado»: en una Ui16, un corte de energía es una caída silenciosa sin FIN que sólo un plazo de lectura detecta.
...
| P0.2a | Especificación del protocolo versión 1 generada | bloqueante | sí | **Sí, y estaba desde el 2026-09-08 sin marcar acá.** `docs/protocol-spec.md`, versión 1; `docs/capability-matrix.md`, 83 filas con estado, versión 1 —eran 78 hasta el 2026-09-16, cuando se fusionaron las dos filas del ecualizador de salida al descubrir que eran la misma cosa, y volvieron a subir a 79 el mismo día, cuando una auditoría encontró que el pasa-bajos y el envío a monitor estaban medidos y no tenían fila; y a 83 el 2026-09-20, con las cuatro de los preajustes— | ✅ |
...
2026-09-10 y funciona: `SPK-P0.8/evidence/borrado-instantanea-2026-09-10.txt` —transcripción—, **remedido el 2026-09-11** en `SPK-P0.8/evidence/retencion-y-borrado-2026-09-11.txt`.

...
| P0.2a | Especificación del protocolo versión 1 generada | bloqueante | sí | **Sí, y estaba desde el 2026-09-08 sin marcar acá.** `docs/protocol-spec.md`, versión 1; `docs/capability-matrix.md`, 77 filas con estado, versión 1 —eran 78 hasta el 2026-09-16, cuando se fusionaron las dos filas del ecualizador de salida al descubrir que eran la misma cosa— | ✅ |

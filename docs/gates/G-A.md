...
| P0.2a | Especificación del protocolo versión 1 generada | bloqueante | sí | **Sí, y estaba desde el 2026-09-08 sin marcar acá.** `docs/protocol-spec.md`, 554 líneas, versión 1; `docs/capability-matrix.md`, 74 filas con estado, versión 1 | ✅ |

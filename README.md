...
| Rutas crudas con conversión medida | 12 —frecuencia, Q, pasa-altos y pasa-bajos del ecualizador de canal contra el filtro real; la **ganancia de sus cuatro bandas**, medida una por una; el envío a monitor contra la salida del auxiliar; la **ganancia del ecualizador gráfico de salida en sus dos superficies**, un auxiliar y el general; y el **sostenido de la puerta**, la primera en el dominio del tiempo—, todas con bucle externo. `validate-numeros` las cuenta |
| Rutas crudas que el motor deja escribir | **7 de esas 12**: el envío a monitor, la **ganancia de las cuatro bandas del ecualizador de canal** y la del **ecualizador gráfico de salida en sus dos superficies** —un auxiliar y el general—, todas en dB igual que el tope de su `kind`. Las otras cuatro del ecualizador —frecuencia, Q, pasa-altos y pasa-bajos— las sigue rechazando INV-004: `LIMITES` da una unidad por `kind` y sus leyes están en Hz y en Q contra un tope en dB ([hallazgo](docs/backlog/hallazgo-un-kind-una-unidad-y-las-hojas-no-coinciden.md)). Medir la ganancia sí las mueve porque es la única hoja del ecualizador cuya unidad coincide con la del tope |

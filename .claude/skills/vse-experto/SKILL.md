...
npm test              # 195 tests de los seis paquetes
...
**Antes de abrir un PR**: `npm run lint`, `npm test`, `npm run test:dsp`, `npm run validate:docs`. Si tocaste interfaz, además las capturas.
